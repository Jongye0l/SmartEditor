...
public class GenericEvent : LoadSequence {
    ...
    public void LoadEvent(int floor) => max = floor;
    ...
    public void ApplyEvent() {
        try {
            ...
            string text = Main.Instance.Localization["AsyncMapLoad.GenericEvent1"];
            ...
            if(max == floorAngles.Count) {
                SequenceText = Main.Instance.Localization["AsyncMapLoad.GenericEvent2"];
            ...
            Main.Instance.LogReportException("Work GenericEvent Fail", e);
        }
    }
